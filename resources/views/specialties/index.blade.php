...
<div class="card shadow">
    ...
    <div class="card-body">
         <!-- Muestra las notificaciones contenidas en notification que vienen de SpecialtyController -->
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="{{ url ('/specialties/'.$specialty->id) }}" method="POST">
                                    ...
                                    <button onclick="return confirm('¿Seguro que desea eliminar esta especialidad?');" 
